...
class UserKeyboards:
    ...
    def inst_out_but():
        ...
        ios = InlineKeyboardButton(text='Ios', url="https://apps.apple.com/us/app/outline-app/id1356177741")
        mac = InlineKeyboardButton(text='MacOS', url="https://apps.apple.com/us/app/outline-secure-internet-access/id1356178125?mt=12")
        win = InlineKeyboardButton(text='Windows', callback_data='win_out')
        lin = InlineKeyboardButton(text='Linux', callback_data="lin_out")

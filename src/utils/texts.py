...
""")
    ...
    @staticmethod
    def del_key():
        return """🔌 Упс, время истекло...
Ваш баланс ушел в ноль, и нам пришлось временно отключить ваш VPN-ключ. Но это легко исправить!
Как только вы закинете монету на баланс, магия Argent снова заработает, и вы сможете в один клик выпустить себе новый ключ. Ждем вашего возвращения!"""

    @staticmethod
    def warning_balance():
        return """⏳ VPN на грани отключения!
Ваш баланс тает на глазах. Самое время заглянуть в меню.
Не теряйте скорость! 🚀"""
